      ...
      <section className="relative py-20 px-6 text-center text-gray-300 bg-black overflow-hidden">
        ...
        <div className="flex justify-center space-x-4 mb-8">
          {["About", "Project", "Experience"].map((item) => (
            <button key={item} className="px-6 py-2 rounded-full bg-neutral-900 text-white border border-gray-700 hover:border-white transition">
              {item}
            </button>
          ))}
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="w-10 h-10 flex items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-cyan-400 text-black font-bold">
            1
          </div>
        </div>
  
        <h2 className="text-3xl sm:text-4xl font-bold mt-4 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent">
          About
        </h2>
